...
q0:{aTransitions:[], bTransitions:[], lTransitions:["q2","q6"],eClosure:["q0","q2","q6"], accepting:false},

q2:{aTransitions:[], bTransitions:["q3"], lTransitions:[], eClosure:["q2"], accepting:false},

q3:{aTransitions:[], bTransitions:[], lTransitions:["q4"], eClosure:["q3", "q4"],accepting:false},

q4:{aTransitions:["q5"], bTransitions:[], lTransitions:[], eClosure:["q4"], accepting:false},

	
q5:{aTransitions:[], bTransitions:[], lTransitions:["q2", "q6"], eClosure:["q2","q5","q6"], accepting:false},


q6:{aTransitions:[], bTransitions:[], lTransitions:[], eClosure:["q6"], accepting:true}
	}
...
function testCase2()
{
	...
	nfa = {
	q0:{aTransitions:[], bTransitions:[], lTransitions:["q2","q6"],eClosure:["q0","q2","q6"], accepting:false},
	q1:{aTransitions:[], bTransitions:[], lTransitions:["q2","q6"],eClosure    :["q0","q2","q6"], accepting:false},
	q0:{aTransitions:[], bTransitions:[], lTransitions:["q2","q6"],eClosure    :["q0","q2","q6"], accepting:false},
	q0:{aTransitions:[], bTransitions:[], lTransitions:["q2","q6"],eClosure    :["q0","q2","q6"], accepting:false}
	}
...
for(var key in inDfa)
{
 ...
 document.getElementById("dfaTable").innerHTML += '<tr> <th>'+key+'</th><td>'+inDfa[key].aTransitions.join(",")+'</td><td>'+inDfa[key].bTransitions.join(",")+'</td><td>'+inDfa[key].accepting+'</td>'
}
