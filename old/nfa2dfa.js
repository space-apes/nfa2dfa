...
the newest version of this includes a fix to not count permutations of 
...
q0:{aTransitions:[], bTransitions:[], lTransitions:["q2","q6"],eClosure:[], accepting:false},

q2:{aTransitions:[], bTransitions:["q3"], lTransitions:[], eClosure:[], accepting:false},

q3:{aTransitions:[], bTransitions:[], lTransitions:["q4"], eClosure:[],accepting:false},

q4:{aTransitions:["q5"], bTransitions:[], lTransitions:[], eClosure:[], accepting:false},

	
q5:{aTransitions:[], bTransitions:[], lTransitions:["q2", "q6"], eClosure:[], accepting:false},


q6:{aTransitions:[], bTransitions:[], lTransitions:[], eClosure:[], accepting:true}
	}
	addClosures(nfa)
	dfa = nfa2Dfa(nfa)
	tableRender(nfa,dfa)
...
function testCase2()
{
	...
	nfa = {
	q0:{aTransitions:["q1"], bTransitions:[], lTransitions:[],eClosure:[], accepting:false},
	q1:{aTransitions:[], bTransitions:["q2"], lTransitions:["q0"],eClosure:[], accepting:false},
	q2:{aTransitions:["q1"], bTransitions:[], lTransitions:[],eClosure:[], accepting:true},
	q3:{aTransitions:[], bTransitions:["q0"], lTransitions:["q2"],eClosure    :[], accepting:false}
	}
